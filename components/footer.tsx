...
export default function Footer() {
  return (
    <footer className="bg-pink-600 text-white pt-12 pb-6 mt-10 mb-0">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Logo and About */}
        <div>
          <img src="/logo.svg" alt="Kopila Clinic Logo" className="h-16 mb-4 invert" />
      ...
      <div className="mt-10 border-t border-white/20 pt-6 text-center text-sm text-white/80">
        <p> Copyright &copy; {new Date().getFullYear()} Kopila Fertility & Womens Clinic, Damak, Jhapa, Nepal. All Rights Reserved.</p>
      </div>
    </footer>
  );
}
