...
import { FaArrowRight, FaPlayCircle, FaPhoneAlt, FaWhatsapp, FaUserMd, FaClinicMedical, FaCalendarAlt, FaClock, FaMapMarkerAlt, FaEnvelope } from "react-icons/fa";
...
export default function page() {
  return (
    <div className="min-h-screen bg-green-50 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10 flex flex-col justify-center h-full">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-5xl font-extrabold text-pink-700 mb-6 leading-tight drop-shadow-lg">
                Fertility <span className="text-green-600">and</span> <br/> <span className="text-pink-700">Womens Clinic</span>
              </h1>
            ...
            <div className="relative flex justify-center items-center">
              ...
              <div className="relative w-full max-w-md mx-auto">
                <Image src="/hero-img.png" alt="Mother and child" className="w-full h-auto"  style={{minHeight:'600px'}} />
                
              <div className="absolute bottom-70 left-10 w-20 h-20 p-2 bg-white rounded-full flex items-center justify-center shadow-lg">
                <Image src="baby-stroller.svg" alt="" />
              </div>
      ...
      {/* About Section */}
       <section className="flex flex-col md:flex-row items-center justify-between gap-16 px-2 py-32 max-w-12xl mx-auto">
      {/* Left Image Section */}
  ...
  <Image src="about-experience-circle.png" alt="" className="w-full h-full animate-rotate360" />
</div>
     ...
     {/* Services Section */}
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {Services.slice(0, 4).map((service: { title: string; desc: string }, index: number) => (
            <div
              key={index}
            ...
            >
              <div className="flex justify-center mb-4">
                <Image
                  src="/service.svg" // assuming a common static icon
                  alt={service.title}
                  width={40}
                  height={40}
                />
